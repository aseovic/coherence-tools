...
public class JpaLoaderTest
    ...
    private static EntityManagerFactory EM_FACTORY =
            Persistence.createEntityManagerFactory("com.seovic.loader");
    ...
    public void testJpaSource_singleBatch()
        ...
        Source source = new JpaSource("com.seovic.loader", Country.class);
    ...
    public void testJpaSource_multiBatch()
        {
        populate(createCountries());
        JpaSource source = new JpaSource("com.seovic.loader", Country.class);
    ...
    public void testJpaTarget()
        ...
        Target target = new JpaTarget("com.seovic.loader", Country.class);
        Loader l = new DefaultLoader(source, target);
        l.load();
